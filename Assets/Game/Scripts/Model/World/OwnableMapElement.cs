...
namespace MS.Model
{
	public class OwnableMapElement : MapElement
	{
        ...
        public OwnableMapElement()
        {
            ...
            if (Managers.GameManager.Instance != null && Game.Instance != null)
            {
                Owner = Game.Instance.Players.Find("Neutral");
            }
        }
